...
/**
 * function to save a personal default view in cookies
 */
function extendMap() {
...
function saveBboxtoCookies() {
    //TODO: if (wenn keine Bbox im Bbox Layer eingezeichnet wurde, dann soll der neue Ausschnitt hier als Bbox dienen)
